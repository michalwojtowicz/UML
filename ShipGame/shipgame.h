...
#include "ui_shipgame.h"
#include <iostream>
#include <string.h>
#include "qhoversensitivebutton.h"

class ShipGame : public QMainWindow
{
	Q_OBJECT

public:
	ShipGame(QWidget *parent = 0);
	~ShipGame();
...
private:
	...
	int *ilosc_button = new int[4];
	int **plansza = new int*[10];
	int counter = 10;
	QHoverSensitiveButton ***planszaUser = new QHoverSensitiveButton**[10];
